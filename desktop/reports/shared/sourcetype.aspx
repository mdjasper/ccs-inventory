<%@ Page Title="" Language="C#" MasterPageFile="~/desktop/MasterPage.master" AutoEventWireup="true" CodeFile="sourcetype.aspx.cs" Inherits="desktop_reports_incoming_SourceType"  %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="PlaceHolder_Content" Runat="Server">
    ...
    <h1>Source Types</h1>
    <div id="Title">
       <asp:Label ID="lblQuest" runat="server" Text="Please Select the Source Types you would like to show up on the Report"></asp:Label>
</div>
...
<style>
   #Title {text-align:center; margin: 0px auto;}
    ...
    <div id="InputForm">
        ...
        <br />
        <uc2:ListSelectionControl ID="lstFoodSourceTypes" runat="server" />
        <br />
    </div>
    <style>
