<%@ Page Title="" Language="C#" MasterPageFile="~/desktop/MasterPage.master" AutoEventWireup="true" CodeFile="displayinoutreport.aspx.cs" Inherits="desktop_reports_in_out_displayinoutreport" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="PlaceHolder_Content" Runat="Server">
       ...
       <asp:scriptmanager ID="Scriptmanager1" runat="server"></asp:scriptmanager>
        ...
        <LocalReport ReportPath="desktop\reports\in-out\inout.rdlc">
        </LocalReport>
        </rsweb:ReportViewer>
</asp:Content>
