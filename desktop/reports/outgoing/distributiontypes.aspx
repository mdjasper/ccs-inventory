<%@ Page Title="" Language="C#" MasterPageFile="~/desktop/MasterPage.master" AutoEventWireup="true" CodeFile="distributiontypes.aspx.cs" Inherits="desktop_reports_incoming_DistributionType"  %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="PlaceHolder_Content" Runat="Server">
    ...
    <h1>Dstribution Type</h1>
    <div id="Title">
       <asp:Label ID="lblQuest" runat="server" Text="Please Select the Distribution Types you would like to show up on the Report"></asp:Label>
</div>
...
<style>
   #Title {text-align:center; margin: 0px auto;}
    ...
    <div id="InputForm">
        ...
        <br />
        <uc2:ListSelectionControl ID="lstdistributiontypes" runat="server" />
        <br />
    </div>
    <style>
