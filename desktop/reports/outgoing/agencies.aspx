<%@ Page Title="" Language="C#" MasterPageFile="~/desktop/MasterPage.master" AutoEventWireup="true" CodeFile="agencies.aspx.cs" Inherits="desktop_reports_incoming_Agencies"  %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="PlaceHolder_Content" Runat="Server">
    ...
    <h1>Agencies</h1>
    <div id="Title">
       <asp:Label ID="lblQuest" runat="server" Text="Please Select the Agencies you would like to show up on the Report"></asp:Label>
</div>
...
<style>
   #Title {text-align:center; margin: 0px auto;}
    ...
    <div id="InputForm">
        ...
        <br />
        <uc2:ListSelectionControl ID="lstAgencies" runat="server" />
        <br />
    </div>
    <style>
