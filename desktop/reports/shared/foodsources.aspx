<%@ Page Title="" Language="C#" MasterPageFile="~/desktop/MasterPage.master" AutoEventWireup="true" CodeFile="foodsources.aspx.cs" Inherits="desktop_reports_incoming_FoodSources"  %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="PlaceHolder_Content" Runat="Server">
    ...
    <h1>Sources</h1>
    <div id="Title">
       <asp:Label ID="lblQuest" runat="server" Text="Please Select the Sources you would like to show up on the Report"></asp:Label>
</div>
...
<style>
   #Title {text-align:center; margin: 0px auto;}
    ...
    <div id="InputForm">
        ...
        <br />
        <uc2:ListSelectionControl ID="lstFoodSources" runat="server" />
        <br />
    </div>
    <style>
